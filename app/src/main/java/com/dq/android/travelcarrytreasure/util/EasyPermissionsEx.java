...
/**
 * Utility to request and check System permissions for apps targeting Android M (API >= 23). The permissions helper
 * class is on the basis of EasyPermissions(@link https://github.com/googlesamples/easypermissions).
 *
 * Author: douyoumi (https://github.com/xinshoucb/EasyPermissionsEx/) Date: 2016-09-13 Email: xinshou.cb@gmail.com
 */
public class EasyPermissionsEx {
   ...
   *
   * @param object Activity or Fragment requesting permissions. Should implement {@link
   * ActivityCompat.OnRequestPermissionsResultCallback} or {@link android.support.v13.app.FragmentCompat.OnRequestPermissionsResultCallback}
   * @param rationale a message explaining why the application needs this set of permissions, will be displayed if the
   * user rejects the request the first time.
   ...
   * @param deniedPermissions list of denied permissions, usually from {@link PermissionCallbacks#onPermissionsDenied(int,
   * List)}
   ...
   *
   * @param object Activity or Fragment requesting permissions.
   * @param rationale a message explaining why the application needs this set of permissions, will be displayed on the
   * snackbar.
